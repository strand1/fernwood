...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.fernwood")
	assert.Equal(t, "/home/user/.fernwood/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.fernwood/workspace/file.txt", "/home/user/.fernwood")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".fernwood"), result)
}
